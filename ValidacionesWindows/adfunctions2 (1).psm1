...
$global:dominio = "luiscolio.com"
$global:ouPathC = "OU=cuates,DC=luiscolio,DC=com"
$global:ouPathNC = "OU=no cuates,DC=luiscolio,DC=com"
...
function passwords_seguras(){
    Set-ADDefaultDomainPasswordPolicy -Identity "luiscolio.com" `
    -MinPasswordLength 8 `
